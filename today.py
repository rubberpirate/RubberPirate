...
if __name__ == '__main__':
    """
    Rahul Rajith (rubberpirate) profile README generator.
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'U_kgDOBjMQ5g'} and 2022-04-19T13:18:20Z for username 'rubberpirate'
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # legacy archive data for the upstream profile
